...
<body class="backimg">
   ...
   <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="Email" runat="server" ForeColor="white"  ErrorMessage="This Field is compulsory"></asp:RequiredFieldValidator> 
  </div>
  ...
  <div class="mb-3">
   ...
   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="Password" runat="server" ForeColor="White"  ErrorMessage="This Field is compulsory"></asp:RequiredFieldValidator> 
</div>
